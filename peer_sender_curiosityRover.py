...
def connect_to_peer(host, port):
    ...
    try:
        ...
        ssl_peer_socket = ssl.wrap_socket(peer_socket, certfile='client_cert.pem', keyfile='client_key.pem')
        return ssl_peer_socket
    ...
    try:
        for i in range(1, 6):
            ...
            for peer_ip, port in peer_ip_ports:
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data", current_date, current_hour, "*.csv"))
                if csv_files:
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data/Curiosity_Rover", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data/Mars_Rover", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data/Lander_Module", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data/Mars_Satellite", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/zhangj20/group24/data/Moon_Satellite", current_date, current_hour, "*.csv"))
