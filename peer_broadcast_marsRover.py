        ...
        while True:
            try:
                ...
                if "Delete" in data:
                    ...
                    self.delete_file(file_to_delete, "/users/pgrad/srivastp/group24/data_test")
...
if __name__ == "__main__":
    ...
    current_id = "Mars_Rover"
    current_host = "IP_MARS_ROVER"
    current_port = PORT_MARS_ROVER
