    ...
    try:
        for i in range(1, 6):
            ...
            for peer_ip, port in peer_ip_ports:
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data", current_date, current_hour, "*.csv"))
                if csv_files:
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data/Curiosity_Rover", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data/Mars_Rover", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data/Lander_Module", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data/Mars_Satellite", current_date, current_hour, "*.csv"))
                ...
                csv_files = glob.glob(os.path.join("/users/pgrad/srivastp/group24/data/Moon_Satellite", current_date, current_hour, "*.csv"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--peer_ip_ports", nargs='+', default=[('IP_LANDER_MODULE:PORT_LANDER_MODULE'), ('IP_MARS_SATELLITE:PORT_MARS_SATELLITE')], help="List of tuples containing peer IP addresses and ports")
