...
scripts = ["gps.py", "temperature.py", "cpu_temperature.py", "light_intensity.py", "pressure.py", "sound.py", "wind_speed.py"]

print("Launching scripts...")

# Start each script in a separate thread
for script in scripts:
    thread = threading.Thread(target=run_script, args=("/users/pgrad/jadhavd/group24/" + script,))
    thread.start()
