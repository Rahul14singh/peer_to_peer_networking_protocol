...
if __name__ == "__main__":
    ...
    parser.add_argument("--peer_ip_ports", nargs='+', default=[('IP_MARS_SATELLITE:PORT_MARS_SATELLITE'), ('IP_EARTH:PORT_EARTH')], help="List of tuples containing peer IP addresses and ports")
