        ...
        while True:
            try:
                ...
                if "Delete" in data:
                    ...
                    self.delete_file(file_to_delete, "/users/pgrad/jadhavd/group24/data_test")
...
if __name__ == "__main__":
    ...
    current_id = "Lander_Module"
    current_host = "IP_LANDER_MODULE"
    current_port = PORT_LANDER_MODULE
